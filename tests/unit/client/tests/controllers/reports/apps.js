describe("AdefyReportsAppsController", function() {
  var scope = null;
  ...
  describe('Hover formatters', function () {
    ...
    it("Exposes a number formatter just for earnings", function() {
      scope.should.have.property("hoverFormatEarned");

      hoverText = scope.hoverFormatEarned({ name: "wazzzaaaa" }, 1, 1);
      expect(hoverText).to.be.a("string");
    });
  });
});
