describe("AdefyAdDetailController", function() {
  var scope = null;
  ...
  it("Provides a graphDone handler to load the ad", function(done) {
    AdServiceMock.getAd = function() { done(); };

    scope.should.have.property("graphDone");
    scope.graphDone();
  });
});
